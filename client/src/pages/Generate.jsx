        ...
        <div className="mb-14">
          ...
          <div className="relative">
            <textarea
              ...
              className="w-full h-56 p-6 rounded-3xl bg-black/60 border border-white/10 outline-none resize-none text-sm leading-relaxed focus:ring-2
              focus:ring-white/10"
            ></textarea>
          </div>
          {error && <p className="mt-4 text-sm text-red-400"></p>}
        </div>
