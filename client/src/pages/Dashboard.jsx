                  ...
                  <div className="p-2 flex flex-col gap-4 flex-1">
                    ...
                    {!w.deployed ? (
                      <button
                        ...
                        className="mt-auto flex items-center justify-center gap-2 px-4 py-2 rounded-xl text-xs font-semibold bg-gradient-to-r from-indigo-500 to-purple-500 hover:scale-105 transition"
                      >
